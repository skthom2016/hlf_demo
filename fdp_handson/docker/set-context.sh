...
if [ "$2" == "tls" ] || [ "$2" == "raft" ] ; then
    ...
    export ORDERER_CA_ROOTFILE=$PWD/config/crypto-config/ordererOrganizations/oem.com/orderers/orderer.oem.com/msp/tlscacerts/tlsca.oem.com-cert.pem
