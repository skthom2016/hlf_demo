...
clear
echo "============================================================================================"
echo "Now we are going to generate the Crypto certificates for Orderer Org, Oem Org and Dealer Org."
echo "Here we are using dev crypto generation tool called cryptogen."
echo "In production / live env, the cryptos will be generated using Certificate Authority" 
echo "============================================================================================"
askProceed
...
cp ./config/orderer/LogisticOrdererGenesis.block ./config/oem/LogisticOrdererGenesis.block
echo "=========================="
